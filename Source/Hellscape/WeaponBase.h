...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Weapon Casting")
		/*
		Starts the casting process for the weapon. By default, this casts the spell, though this may involve charging the weapon or starting a targeting sequence.
		This is the prefered function for casting a weapon.
		*/
		void StartCasting();
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Weapon Casting")
		/*
		* Casts the spell/focus. The checks for mana/cooldown/etc are ignored in this method and must be handled by AttemptCast().
		*/
		void Cast();
	...
	/*
	* Makes the behavior of the weapon's area of effect more intense. The weapon has no area of effect at 0.
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon | Weapon Logic")
		/*
		* Tracks if the weapon is currently being cast. Used for behavior such as rapid fire or chargable weapons
		*/
...
#pragma region Event Implementation
	...
	virtual void StopCasting_Implementation();
